    ...
    <div className="w-full">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800">Véhicules</h1>
        </div>
        <Link
          href="/vehicles/new"
          className="flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-lg transition"
        >
          <Plus size={20} />
          Ajouter
        </Link>
      ...
      {!vehicles || vehicles.length === 0 ? (
        <div className="bg-white rounded-lg shadow-lg p-8 sm:p-12 text-center border border-gray-200">
          ...
          <p className="text-gray-500 text-lg mb-6">Aucun véhicule pour le moment</p>
          <Link
            href="/vehicles/new"
            ...
            >
              ...
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-4 flex items-start justify-between">
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-lg sm:text-xl font-bold text-amber-600 break-words">{vehicle.plate}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-4 py-3 bg-gray-50 border-t border-gray-100 flex gap-2">
                <Link
                  ...
                  className="flex-1 px-3 py-2 text-sm font-medium text-amber-600 hover:bg-amber-50 rounded transition text-center"
                >
                  Voir détails
                </Link>
                <Link
                  href={`/vehicles/${vehicle.id}/edit`}
                  className="px-3 py-2 text-gray-600 hover:bg-gray-200 rounded transition"
                  title="Éditer"
                >
                  <Edit2 size={16} />
                </Link>
